...
func TestShouldFire(t *testing.T) {
	...
	tst.Assert(t, true == ShouldFire(hash1, hash2, 3), "It should fire for this distance/threshold")
	tst.Assert(t, false == ShouldFire(hash1, hash2, 2), "It shouldn't fire for this distance/threshold")
}
